...
export class FrontPageComponent implements OnInit {
  frontPageLayout: any[] = [
    ...
    { cols: 1, rows: 1, img: 'https://scontent.ftpe7-4.fna.fbcdn.net/v/t39.30808-6/273553728_484715699911726_1424188458320663819_n.jpg?_nc_cat=101&ccb=1-5&_nc_sid=a26aad&_nc_ohc=BWi91mRF-CUAX_RenCc&_nc_ht=scontent.ftpe7-4.fna&oh=00_AT9foR5MuqC1t2dTRWqqdVpJPI8fAQifpz1wpmtqtaLIEw&oe=62066E80' },
